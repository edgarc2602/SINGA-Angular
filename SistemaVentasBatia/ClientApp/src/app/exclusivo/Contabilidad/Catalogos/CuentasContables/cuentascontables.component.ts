...
import { ListaCuentasContables } from 'src/app/models/Contabilidad/Catalogos/ListaCuentasContables';
import { CuentaContablesAgregarWidget } from 'src/app/widgets/Contabilidad/Catalogos/cuentacontableagregar.widget';
...
@Component({
    selector: 'cuentascontables-comp',
